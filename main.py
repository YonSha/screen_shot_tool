...
class ScreenshotTool(QWidget):
    ...
    def capture_full_screenshot(self):
        ...
        with mss.mss() as sct:
            ...
            if screenshot:
                print(f"Screen captured: dimensions {screenshot.width}x{screenshot.height}")
                image = QImage(
                    screenshot.rgb,
                    screenshot.width,
                    screenshot.height,
    ...
    def save_full_image(self):
        ...
        if self.original_image and self.original_image.save(filepath, "PNG"):
            print(f"Full screenshot saved to '{filepath}'")
        else:
    ...
    def save_cropped_area(self):
        ...
        if self.crop_rect and self.crop_rect.isValid():
            ...
            if cropped.save(filepath, "PNG"):
                print(f"Cropped screenshot saved to '{filepath}'")
            else:
                print(f"Failed to save cropped screenshot to '{filepath}'")
        else:
    ...
    def copy_cropped_to_clipboard(self):
        ...
        if self.crop_rect and self.crop_rect.isValid():
            ...
            print("Cropped screenshot copied to clipboard.")
        else:
            print("No valid crop area selected.")
